...
Revision ID: 20210831110925
Revises: 20210830095204
Create Date: 2021-08-31 11:09:27.674744
...
revision = "20210831110925"
down_revision = "20210830095204"
branch_labels = None
depends_on = None
  ...
  EXISTS INTO level_okay (
    ...
    FROM
      (
        ...
        WHERE
          tenant_id_str = NEW.tenant_id_str
      ) lc
    WHERE
