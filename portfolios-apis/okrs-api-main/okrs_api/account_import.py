"""An utility to import the OKR data from source location."""
...
from okrs_api.api.controller.data_migration import import_from_json_input
...
def main():
    ...
    try:
        ...
        sys.exit(1)
    asyncio.run(import_from_json_input(app, input_json))
