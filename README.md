...
| --------------------- | ----------------------------------------------------------------------------------------------------------- |
| **API URL**           | Your Planview instance URL + `/polaris` (e.g., `https://scdemo5xx.pvcloud.com/polaris`) — **use lowercase** |
| **Client ID**         | Administration → Users → OAuth2 credentials                                                                 |
| **Client Secret**     | Shown once at OAuth credential creation — copy it immediately                                               |
| ** Global Tenant ID** | Ask your Planview admin or find it in the admin panel                                                       |
...
### 2. Download and extract this Repository from GitHub

Download the zip (Code>Download Zip) from GitHub and extract it to a simple path like `C:\portfoliosMCP`.
...
MIT# Planview Portfolios Actions MCP Server
